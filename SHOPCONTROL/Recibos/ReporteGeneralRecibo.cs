...
{
    public partial class ReporteGeneralRecibo : Form
    {
        public ReporteGeneralRecibo()
        {
            InitializeComponent();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string Query = "Update Detallesrecibos set cvproducto=cvunica where cvproducto=''";
            conecta.Excute(Query);

            Query = "Update Detallesrecibos set cvunica=cvproducto where len(cvunica)=1";
            conecta.Excute(Query);
        ...
        public void ListadoFacturasAvanzado()
        {
            ...
            Lv.Columns.Add("Num. Recibo", 50);
            Lv.Columns.Add("Nombre", 110);
            Lv.Columns.Add("Fecha Realizo", 90);
            Lv.Columns.Add("Emitio", 55);
            Lv.Columns.Add("Subtotal", 80, HorizontalAlignment.Right);
            Lv.Columns.Add("IVA", 75, HorizontalAlignment.Right);
            Lv.Columns.Add("Total", 80, HorizontalAlignment.Right);
            Lv.Columns.Add("Tipo Pago", 90, HorizontalAlignment.Right);
            Lv.Columns.Add("Entregado", 45, HorizontalAlignment.Right);
            Lv.Columns.Add("Fecha de Entrega", 50, HorizontalAlignment.Right);
            Lv.Columns.Add("Vendedor", 80, HorizontalAlignment.Right);


            string TipodePago = comboBox3.Text;
            string OtroPago = "CONTADO";
            if (TipodePago == "POR PAGAR")
            {
                TipodePago = "CREDITO";
                OtroPago = "POR PAGAR";
            }
            ...
            if (textBox1.Text != "") Query = Query + "  and nombrerecibo='" + textBox1.Text + "'";
            if (comboBox1.Text != "") Query = Query + "  and vendedor='" + comboBox1.Text + "'";
            if (comboBox2.Text != "") Query = Query + "  and entregado='" + comboBox2.Text + "'";
            if (comboBox3.Text != "") Query = Query + "  and ( tiporecibo='" + TipodePago + "' or tiporecibo='" + OtroPago + "')";
            if (comboBox4.Text != "") Query = Query + "  and emitio='" + comboBox4.Text + "'";
            ...
            while (leer.Read())
            {
                ...
                string fecha = leer["fecha"].ToString();
                string renombre= leer["nombrerecibo"].ToString();
                string emitioR = leer["emitio"].ToString();
                string tiporecibo = leer["tiporecibo"].ToString();
                string entregado = leer["entregado"].ToString();
                ...
                if (tiporecibo == "CONTADO") tiporecibo = "PAGADO";

                decimal Timporte = decimal.Parse(leer["total"].ToString());
                decimal Tadicional = decimal.Parse(leer["iva"].ToString()) ;
                decimal Ttotal = decimal.Parse(leer["totalgeneral"].ToString());
                RecTotalImporte = RecTotalImporte + Timporte;
                ...
                lvi.SubItems.Add(fecha);
                lvi.SubItems.Add(emitioR);
                lvi.SubItems.Add(Timporte.ToString("#,#.00", CultureInfo.InvariantCulture));
                lvi.SubItems.Add(Tadicional.ToString("#,#.00", CultureInfo.InvariantCulture));
                lvi.SubItems.Add(Ttotal.ToString("#,#.00", CultureInfo.InvariantCulture));
                lvi.SubItems.Add(tiporecibo);
                lvi.SubItems.Add(entregado);
                lvi.SubItems.Add(fechaentrega);
                lvi.SubItems.Add(vendedor);
                Lv.Items.Add(lvi);
            }
            conecta.CierraConexion();
            label1.Text = Rttotal.ToString("#,#.00", CultureInfo.InvariantCulture);
            label15.Text = Lv.Items.Count.ToString();
        ...
        {
            combos.UsuariosSistema(comboBox4);
            combos.ComboVendedores(comboBox1);
            BusquedaUsuario();
            label13.Text = "Información de Recibos";
        ...
        private void button17_Click(object sender, EventArgs e)
        {
            ...
            string TipodePago = comboBox3.Text;
            if (TipodePago == "POR PAGAR") TipodePago = "CREDITO";
            if (TipodePago == "PAGADO") TipodePago = "CONTADO";

            Cadena = reportes.ReportePorAVANZADORECIBO(dateTimePicker1.Value.ToString(), dateTimePicker2.Value.ToString(), textBox11.Text, textBox18.Text, comboBox4.Text, TipodePago, comboBox2.Text, comboBox1.Text, textBox1.Text, "");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Cadena = reportes.ReportePorConceptoRECIBO(dateTimePicker1.Value.ToString(), dateTimePicker2.Value.ToString(), textBox11.Text, textBox18.Text);
            try
            {
                System.Diagnostics.Process.Start(Cadena);
            }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Cadena = reportes.ReportePorReciboDetalladoRECIBOS(dateTimePicker1.Value.ToString(), dateTimePicker2.Value.ToString(), textBox11.Text, textBox18.Text, comboBox4.Text, TipodePago, comboBox2.Text, comboBox1.Text, textBox1.Text, "");
        ...
        {
            //string cadenaDocumentopdf = CADDIRECCION + "\\F" + NUMFACTURA + ".pdf";
            //try
            //{
