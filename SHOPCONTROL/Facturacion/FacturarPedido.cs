...
namespace SHOPCONTROL
{
    public partial class FacturarPedido : Form
    {
        ...
        public void ENVIARCORREO(string correoDestino, string adjunto, string adjunto2)
        {
            ...
            if (CORREODESTINATARIO2.Trim()!="" && CORREODESTINATARIO2.Length>5) mail.To.Add(new MailAddress(CORREODESTINATARIO2)); 
        ...
        public void MandarFacturar(string numpedido, string ayo)
        {
            ...
            if (FacturarcionOnline(numpedido, ayo) == true && TieneTimbresFacturar()==true)
            {
                ...
                if (NOMBREDEFACTURA.Trim() == "")
                    NombreArchivo = DIRCARPETA + "\\F" + numpedido + "_FACTURA.pdf";
                else
                ...
                ENVIARCORREO(CORREODESTINATARIO, NombreArchivo, Archivo2); // correo electronico
        ...
        public bool FacturarcionOnline(string NUMRECIBO, string ayo)
        {
            ...
            for (int i = 0; i < totalreg; i++)
            {
                ...
                comprobante.Conceptos[i].cantidad = decimal.Parse(MatrizDetalle[i, 1].ToString());
            ...
            try
            {
                ...
                if (resultadoTimbre.Exitoso)
                {
                    ...
                    if (resultadoTimbre.GuardaCodigoBidimensional(DIRCARPETA, "COD_" + NUMRECIBO))
                    {
                        ...
                        mycon.CierraConexion();
                        System.IO.File.Delete(DIRCARPETA + "\\COD_" + NUMRECIBO + ".jpg");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (fuefacturado(numpedido, ayo) == true)
                ...
                MandarFacturar(numpedido, ayo);
        }

        public bool fuefacturado(string numpedido, string ayo)
        {
            conectorSql conecta = new conectorSql();
            string Query = "Select * from facturas where numfactura='" + numpedido + "' and ayo='" + ayo + "' and folioFiscal<>''";
