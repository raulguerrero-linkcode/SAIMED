...
{
    public partial class Pedidospro : Form
    {
        public Pedidospro()
        {
            InitializeComponent();
        ...
        private void RemisionPro_Activated(object sender, EventArgs e)
        {
            ...
            if (Modremision.CVCLIENTE != "" && Modremision.CVCLIENTE!=null)
            {
            ...
            if (Modremision.CVPRODUCTO != "" && Modremision.CVPRODUCTO!=null)
            {
            ...
            if (valoresg.NUMPEDIDOCARGAR != "" && valoresg.NUMPEDIDOCARGAR!=null)
            {
                textBox18.Text = "";
                comboBox5.Text = "";
