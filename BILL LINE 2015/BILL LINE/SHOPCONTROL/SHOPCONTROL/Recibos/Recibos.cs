...
namespace SHOPCONTROL
{
    public partial class Recibos : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            Query = Query + ",fecha,total,iva,totalgeneral,compro,ayo,estatusrecibo,colonia,emitio,entregado,tiporecibo";
            ...
            if (Validacion() == true)
            {
                if (ExisteInfo() == false)
                {
                   ...
                   // AplicarNumremision(valoresg.NUMPEDIDO, valoresg.AYOPEDIDO);
                    ...
                    MandarReporteCristal(valoresg.NUMPEDIDO, valoresg.AYOPEDIDO);
                ...
                else
                {
                    ...
                    MessageBox.Show("Se modifico correctamente el recibo ", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    Limpiar();
                    LimpiarCliente();
                    label67.Visible = false;


                    reply = MessageBox.Show("¿Desea imprimir nuevamente el recibo?", "Recibo", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    if (reply == DialogResult.No)
                    {
                        return;
                    }
                    MandarReporteCristal(label17.Text, valoresg.AYOPEDIDO);
        ...
        public void MandarReporteCristal(string numrecibo, string   ayorecibo)
        {
            ...
            string NombreArchivo = @"C:\RECIBOS\ReciboTicket" + numrecibo.ToString() + ".pdf";
        ...
        */
        ...
        private void button22_Click(object sender, EventArgs e)
        {
            ...
            MandarReporteCristal(numpedido, ayo);
        }
