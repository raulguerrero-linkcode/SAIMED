...
namespace SHOPCONTROL
{
    public partial class Productos : Form
    {
        ...
        public void Recolectar()
        {
            ...
            if (textBox8.Text.Trim() == "") textBox8.Text = "0";
            ...
            DISTRIBUIDOR = decimal.Parse(textBox8.Text);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            while (leer.Read())
            {
                ...
                decimal num = decimal.Parse(leer["cantidad"].ToString());
                ...
                if (num <= (num5 + 2))
                {
                    ...
                    lvi.SubItems[4].BackColor = Color.FromArgb(0xf7, 190, 0x81);
                }
                if (num < num5)
                {
                    lvi.BackColor = Color.FromArgb(0xd9, 0xdf, 0xfb);
                    lvi.SubItems[4].BackColor = Color.FromArgb(0xb2, 5, 5);
                    lvi.SubItems[4].ForeColor = Color.FromArgb(0xff, 0xff, 0xff);
                }
        ...
        public void BuscarInformacion(string clave)
        {
            ...
            while (leer.Read())
            {
                ...
                comboBox1.Text = leer["categoria"].ToString();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            ReportesNKB.RBusquedaProductos(textBox11.Text, comboBox2.Text,comboBox4.Text.Trim(),textBox23.Text.Trim(),comboBox7.Text.Trim(),porsurtir);
        }
        ...
        public void CalculoPrecio1()
        {
            ...
            decimal Distribuidor=decimal.Parse(textBox8.Text);
