...
namespace SHOPCONTROL
{
    public partial class VentaRegistroCobro : Form
    {
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Se realizo el pago total del recibo, gracias", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                label5.Text = "0";
                label4.Text = "0";
                label11.Text = "0";
            ...
            if (comboBox1.SelectedIndex == 2) pagocon = "CREDITO";
          ...
          //  MessageBox.Show("Se guardo correctamente el cobro", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
            this.Dispose();
        ...
        public void buscarNumpedido()
        {
            ...
            SqlDataReader leer = null;
            decimal totalgen = 0;
            string Query = "Select totalgeneral from recibos where numrecibo='" + NUMPEDIDO + "'";
            ...
            label4.Text = acumula.ToString();
            label5.Text = totalgen.ToString();

            decimal porpagar = totalgen - acumula;
            label11.Text = porpagar.ToString();
