...
namespace SHOPCONTROL.HistorialClinica
{
    public partial class CatDoctores : Form
    {
        ...
        public bool Guardar()
        {
            ...
            string Query = "Insert into Doctores(cvdoctor,nombre,especialidad,HoraEntrada,HoraSalida,TiempoConsulta,HoraEcomedor,HoraSComedor, Dcomedor,tipoexpediente) values('" + cvdoctor + "','" + nombre + "','" + especialidad + "','" + horaentrada + "','" + horasalida + "','" + tiempocon + "','" + horaecomedor + "','" + horascomedor + "','" + Dcomedor + "','" + tipoexpediente+ "')";
